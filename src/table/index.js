...
useEffect(()=>{
  ...
  const tottal =tableData.map((item)=>parseInt(item.price)+parseInt(item.veneerExtra)+parseInt(item.actionTExtra))
...
convertArrayOfJsonToCsv(refniedData, "Virdi Furniture");
  ...
  return (
    <div ref={tableRef} id="table-virid" className="main" styles={{width:"100%"}}>
      ...
      <table id="VirdiTable" width="100%">
        ...
        <tfoot>
          ...
          <tr>
            <td colSpan="11">PACKING CHARGES</td>
            <td id="table-packing-charges" >
              Rs.0
            </td>
          </tr>
          <tr>
            <td colSpan="11">GST 18%</td>
            <td id="table-gst" >
              Rs.{gst}
            </td>
          </tr>
          <tr>
            ...
            <td id="table-grand-total">Rs.{parseInt(total)+parseInt(gst)}</td>
          </tr>
        </tfoot>
      </table>
